<?php
/**
 * Shwaripay - A Sample Payment Module for PrestaShop 1.7
 *
 * This file is the declaration of the module.
 *
 * @author Samuel Simiyu <simiyusamuel869@gmail.com>
...
class Shwaripay extends PaymentModule
{
    private $_html = '';
    ...
    public function __construct()
    {
        ...
        $this->version                = '2.0.6';
        $this->author                 = 'Samuel Simiyu';
        $this->controllers            = array('payment', 'validation');
        $this->currencies             = true;
        $this->currencies_mode        = 'checkbox';
        $this->bootstrap              = true;
        $this->displayName            = 'Lipa Na M-PESA';
        $this->description            = 'Shwaripay Lipa Na M-PESA Module(STK Push, C2B)';
        $this->confirmUninstall       = 'Are you sure you want to uninstall Shwaripay module?';
    ...
    {
        if (!parent::install() || !$this->registerHook('paymentOptions') || !$this->registerHook('paymentReturn') || !Configuration::updateValue('RAVEPAYMENTGATEWAY_NAME', 'shwaripay')) {
            return false;
          }
    ...
    {
        if (((bool)Tools::isSubmit('submitshwaripayModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitshwaripayModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'desc' => $this->l('Get your API Consumer Key from https://api.safaricom.co.ke'),
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'prefix' => '<i class="icon icon-key"></i>',
                        'desc' => $this->l('Get your API Consumer Secret from https://api.safaricom.co.ke'),
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'prefix' => '<i class="icon icon-key"></i>',
                        'desc' => $this->l('Get your Pass Key from https://api.safaricom.co.ke'),
                        'name' => 'M_PESA_PASS_KEY',
                        'label' => $this->l('Pass Key'),
                    ),
                ),
                'submit' => array(
                    'title' => $this->l('Save'),
    ...
    protected function getConfigFormValues()
    {
        return array(
            ...
            'M_PESA_CONSUMER_KEY' => Configuration::get('M_PESA_PASS_KEY', 'Pass Key'),
        );
    }
    ...
    public function hookPaymentOptions($params)
{
    ...
    $paymentForm = $this->fetch('module:shwaripay/views/templates/hook/payment_options.tpl');
    ...
    public function hookPaymentReturn($params)
    {
        ...
        return $this->fetch('module:shwaripay/views/templates/hook/payment_return.tpl');
    }

    public function installOrderState()
    {
      if (!Configuration::get('PS_OS_SHWARIPAY_PAYMENT')) {
        ...
        if ($order_state->add()) {
          ...
          Configuration::updateValue('PS_OS_SHWARIPAY_PAYMENT', $order_state->id);
