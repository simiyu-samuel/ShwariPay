...
class ShwaripayCallbackModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        try {
            // Get raw JSON input from the api callback
    ...
    private function logMessage($message)
    {
        ...
        $logFile = _PS_MODULE_DIR_ . 'shwaripay/logs/log.txt';
